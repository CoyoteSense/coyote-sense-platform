...
import { HttpClientOptions, ReplayModeOptions } from '../interfaces/configuration.js';
...
import { MockHttpClient } from '../mock/mock-http-client.js';
...
export class ReplayHttpClient extends BaseHttpClient {
  ...
  private getNextMatchingRecording(request: HttpRequest): RecordedInteraction | undefined {
    while (this.currentIndex < this.recordingQueue.length) {
      ...
      if (this.matchesRequest(recording.request, request)) {
        return recording;
      }
