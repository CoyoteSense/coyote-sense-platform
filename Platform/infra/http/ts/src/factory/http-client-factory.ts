...
import { HttpClient, CoyoteHttpClient } from '../interfaces/http-client';
import { 
  RuntimeMode, 
  HttpClientConfig, 
  HttpClientOptions, 
...
import { RealHttpClient } from '../modes/real/real-http-client';
import { MockHttpClient } from '../modes/mock/mock-http-client';
import { DebugHttpClient } from '../modes/debug/debug-http-client';
import { RecordHttpClient } from '../modes/record/record-http-client';
import { ReplayHttpClient } from '../modes/replay/replay-http-client';
import { SimulationHttpClient } from '../modes/simulation/simulation-http-client';
...
export class HttpClientContainer {
  ...
  getHttpClient(): CoyoteHttpClient {
    return this.factory.createHttpClient();
  }
 ...
 */
export function createHttpClient(mode: RuntimeMode = RuntimeMode.REAL, logger?: Console): CoyoteHttpClient {
