# Http Infrastructure Component

## Overview
The Http component provides [brief description of component purpose and capabilities].
...
docker build -f src/dotnet/Dockerfile -t coyote/infra-http-dotnet .
```
