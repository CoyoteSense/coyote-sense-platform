...
from impl.real.auth_client_real import RealAuthClient
...
class AuthClientFactory:
    ...
    def create_client(
        ...
        Args:
            ...
            mode: Runtime mode ("real", "mock", "debug") - if None, uses config.mode
        ...
        if mode == "real":
            return RealAuthClient(config, token_storage, logger)
        elif mode == "mock":
