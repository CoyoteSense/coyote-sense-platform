...
using AuthClient = auth::AuthClient;
using TokenManager = auth::TokenManager;
using AuthenticationService = auth::AuthenticationService;
using AuthServiceFactory = auth::AuthServiceFactory;

// Legacy OAuth2 type aliases
using OAuth2Client = auth::AuthClient;
using OAuth2TokenManager = auth::TokenManager;
using OAuth2AuthenticationService = auth::AuthenticationService;
using OAuth2ServiceFactory = auth::AuthServiceFactory;
