...
{    /// <summary>
    ...
    /// <summary>
    /// Synchronous version of AuthenticateClientCredentialsAsync
    /// </summary>
    AuthResult AuthenticateClientCredentials(List<string>? scopes = null);
    
    /// <summary>
    /// Synchronous version of AuthenticateJwtBearerAsync
    /// </summary>
    AuthResult AuthenticateJwtBearer(string? subject = null, List<string>? scopes = null);
    
    /// <summary>
    /// Synchronous version of AuthenticateAuthorizationCodeAsync
    /// </summary>
    AuthResult AuthenticateAuthorizationCode(string authorizationCode, string redirectUri, string? codeVerifier = null);
    
    /// <summary>
    /// Synchronous version of RefreshTokenAsync
    /// </summary>
    AuthResult RefreshToken(string refreshToken);
    
    /// <summary>
    /// Synchronous version of GetValidTokenAsync
    /// </summary>
    AuthToken? GetValidToken();
    
    /// <summary>
    /// Synchronous version of RevokeTokenAsync
    /// </summary>
    bool RevokeToken(string token, string? tokenTypeHint = null);
    
    /// <summary>
    /// Synchronous version of IntrospectTokenAsync
    /// </summary>
    bool IntrospectToken(string token);
    
    /// <summary>
    /// Synchronous version of TestConnectionAsync
    /// </summary>
    bool TestConnection();
    
    /// <summary>
    /// Synchronous version of GetServerInfoAsync
    /// </summary>
